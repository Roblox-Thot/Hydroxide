...
local function generateScriptFormat(elementIndex)
    local generatedScript = [[-- Generated by Hydroxide's Upvalue Scanner

local aux = loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/Roblox-Thot/Hydroxide/revision/ohaux.lua"))()
